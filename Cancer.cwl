...
steps:
  ...
  cancer-unspecif---primary:
    run: cancer-unspecif---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-retroperitoneum---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-unspecif---primary/output
  ...
  multiple-cancer---primary:
    run: multiple-cancer---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-chest---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: multiple-cancer---primary/output
  ...
  cancer-system---primary:
    run: cancer-system---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-spine---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-system---primary/output
  ...
  cancer-mediastinum---primary:
    run: cancer-mediastinum---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-eyeball---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-mediastinum---primary/output
  ...
  autonomic-cancer---primary:
    run: autonomic-cancer---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-clavicle---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: autonomic-cancer---primary/output
  ...
  inguinal-cancer---primary:
    run: inguinal-cancer---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  lacrimal-cancer---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: inguinal-cancer---primary/output
